...
from .listings.views import (
    UnitListingListView,
    UnitListingDetailView,
    UploadListingImageAPIView,
    CollectListingViewsAPIView,
    PropertyViewInterestsAPIView,
    ListingImageListView,
    ClientRequestsAPIView,
    ClientRequestDetailAPIView,
)
...
urlpatterns = [
    ...
    path(
        "property-view-interests/",
        PropertyViewInterestsAPIView.as_view(),
        name="property-view-interest",
    ),
    path(
        "collect-listing-views/",
        CollectListingViewsAPIView.as_view(),
        name="collect-listing-views",
    ),
    path(
        "client-requests/<int:id>/",
        ClientRequestDetailAPIView.as_view(),
        name="client-request-detail",
    ),
    path("paystack-webhook/", PaystackWebhookView.as_view(), name="paystack-webhook"),
    path("metrics/", MetricsView.as_view(), name="metrics"),
    path(
        "upload-listing-images/<int:listing_id>/",
        UploadListingImageAPIView.as_view(),
        name="upload-listing-images",
    ),
    path("cities/", ListingCityListView.as_view(), name="cities"),
    path(
        "cities/<int:id>/listings/",
        ListingCityListingsView.as_view(),
        name="city-listings",
    ),
