    ...
    def post(self, request, *args, **kwargs):
        ...
        if data.get("event") == "charge.success":
            ...
            webhook_data = {
                ...
                "preferred_contact": payment_data.get("metadata", {}).get(
                    "preferred_contact"
                ),
                ...
                "payment_method": {
                    ...
                    "country_code": payment_data.get("authorization", {}).get(
                        "country_code"
                    ),
                },
            }
...
class MetricsView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        total_revenue = (
            PaymentRecord.objects.all().aggregate(total=Sum("amount"))["total"] or 0
        )
        listing_types = UnitListing.objects.values("listing_type").annotate(
            count=Count("id")
        )
