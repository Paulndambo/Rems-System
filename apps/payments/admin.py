...
class RentPaymentAdmin(admin.ModelAdmin):
    ...
    list_filter = (
        "rent_bill__unit_bill__unit",
        "rent_bill__unit_bill__month",
        "rent_bill__unit_bill__year",
    )
...
class WaterBillPaymentAdmin(admin.ModelAdmin):
    ...
    list_filter = (
        "water_bill__unit_bill__unit",
        "water_bill__unit_bill__month",
        "water_bill__unit_bill__year",
    )
